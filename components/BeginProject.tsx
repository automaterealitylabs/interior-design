          ...
          <div className="lg:col-span-7">
            ...
            <Reveal className="mt-10 flex flex-wrap items-center gap-4" y={30} duration={1.1} delay={0.2} start="top 94%">
              ...
              <a
                ...
                className="inline-flex items-center gap-2.5 rounded-xs border border-line-light/80 bg-paper/5 px-6 py-4 font-mono text-[11px] uppercase tracking-wider text-paper transition-all duration-300 hover:border-emerald-500/70 hover:bg-emerald-950/30 hover:text-emerald-300"
              >
